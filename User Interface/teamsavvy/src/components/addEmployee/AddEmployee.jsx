                    ...
                    <ModalBody>
                        ...
                        <Label className=""  for="projectname">
                                Project
                                    ...
                                    >
                                    {
                                        projects.map((project, index) => <option key={index} value={project.projectId}>{project.projectName}</option>)
                                    }
                                    </Input>
                        </FormGroup>
                        </Col>
        ...
        <div className="col-md-9 col-sm-12 profileright">
            ...
            <Row>
                ...
                <FormGroup>
                    ...
                    >
                    {
                        departments.map((department, index) => <option key={index} value={department.departmentId}>{department.departmentName}</option>)
                    }
                    </Input>
                </FormGroup>
                </Col>
                ...
                <FormGroup>
                    ...
                    >
                     {
                            roles.map((role, index) => <option key={index} value={role.roleId}>{role.roleType}</option>)
                     }
                    </Input>
                </FormGroup>
                </Col>
            ...
            <FormGroup>
                ...
                >
                {
                   compaines.map((comapany, index) => <option key={index} value={comapany.jobLocationId}>{comapany.location}</option>)
                }
                </Input>
            </FormGroup>
            </Col>
