...
namespace TeamSavvy.Api.Entities.Controllers
{
    ...
    public class DropdownsController : ControllerBase
    {
        ...
        [ProducesResponseType(typeof(ResponseMessage), 401)]
        [ProducesResponseType(typeof(ResponseMessage), 404)]
        public ActionResult<List<CountryDdl>> GetDepartments()
        {
            ActionResult response;
            ResponseMessage responseMessage;
            var res = _dropdownsService.GetDepartments();
        ...
        [ProducesResponseType(typeof(ResponseMessage), 401)]
        [ProducesResponseType(typeof(ResponseMessage), 404)]
        public ActionResult<List<CountryDdl>> GetRoles()
        {
            ActionResult response;
            ResponseMessage responseMessage;
            var res = _dropdownsService.GetRoles();
        ...
        [ProducesResponseType(typeof(ResponseMessage), 401)]
        [ProducesResponseType(typeof(ResponseMessage), 404)]
        public ActionResult<List<CountryDdl>> GetCompanyLocations()
        {
            ActionResult response;
            ResponseMessage responseMessage;
            var res = _dropdownsService.GetCompanyLocations();
